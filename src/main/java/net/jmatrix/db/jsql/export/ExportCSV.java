...
public class ExportCSV implements Export {
   ...
   static String usage=
         "ExportCSV -t <table> -o <file> <connection>";
   
   public ExportCSV(ConnectionInfo ci) {
      conInfo=ci;
   }
   ...
   public static void main(String args[]) throws Exception {
      ...
      ExportCSV export=new ExportCSV(ci);
   ...
   public void exportSQL(File file, String table, String sql) throws SQLException, IOException {
      ...
      CSVFormatter csvformatter=new CSVFormatter(conInfo);
      ...
      try {
         ...
         int rows=csvformatter.format(rs, writer, Integer.MAX_VALUE, sql, table);

         log.info("Exported "+rows+ " rows");
      } finally {
